...
@section('title', 'Tambah Opsi Jawaban')

@section('content')
  <div class="d-flex justify-content-between align-items-center mb-3">
    <div>
      <h3 class="mb-1">Tambah Opsi Jawaban</h3>
  ...
  <div class="card border-0 shadow-sm">
    <div class="card-body">
      <form method="POST" action="{{ route('assessment-options.store', $question) }}">
        @csrf
        ...
        <div class="row g-3 mb-3">
          <div class="col-md-6">
            ...
            <input type="number"
                   ...
                   value="{{ old('option_value', 0) }}"
                   required>
            @error('option_value')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror
            <div class="form-text">
              Misal: 0 = tidak pernah, 1 = jarang, 2 = sering, dst.
            </div>
          </div>
